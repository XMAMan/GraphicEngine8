...
{
    [TestClass]
    public class LightTracingOnEdgeTest //Tests für 6,7 (Alle FullPath-Sampling-Verfahren in Mis-Gewichteter Summe)
    {
        ...
        public void NoDistanceSampling_WithVertexConnection() //Test 6 (Alle Verfahren als Summe mit MIS-Gewicht)
        {
            ...
            //string error = expected.CompareAllPathsWithOther(actual, testSzene.maxContributionError);
            string error = expected.CompareOnlyProvidedPathsWithOther(actual, testSzene.maxContributionError, new string[] { "C P L", "C P D L", "C D D L", "C D D D L", "C P D D L", "C P D D D L", "C D D D D L", "C D D D D D L", "C P D D D D L" });
            Assert.IsTrue(string.IsNullOrEmpty(error), error, error);
        }

        //Der MIS-2er-Kominbtionstest für NoDistance mit DirectLightingOnEdge befindet sich in der DirectLightingOnEdge-Test-Klasse
        ...
        public void WithDistanceSampling_WithPathTracing() //Test 6 (Alle Verfahren als Summe mit MIS-Gewicht)
        {
            ...
            //string error = expected.CompareAllPathsWithOther(actual, testSzene.maxContributionError);
            string error = expected.CompareOnlyProvidedPathsWithOther(actual, testSzene.maxContributionError, new string[] { "C D L", "C P L", "C P D L", "C D D L", "C D P L", "C P P L", "C D P P L", "C D D D L", "C P P D L", "C P D D L", "C D P D L", "C D D P L", "C P P P L", "C P D P L", "C P P P D L", "C D P D D L", "C P D D P L", "C P D P P L", "C P D P D L", "C P P D D L", "C D P P P L", "C D D P D L", "C D P D P L", "C P P D P L", "C P D D D L", "C D D D D L", "C D P P D L", "C D D P P L", "C P P P P L", "C D D D P L", "C D P D D P L", "C P D D P D L", "C P P P D D L", "C D D D P D L", "C D D P D D L", "C D D D P P L", "C D P P D D L", "C D P D P P L", "C D P D D D L", "C D D D D D L", "C P D D D D L", "C P D D D P L", "C D D D D P L", "C D D P D P L", "C P D P P D L", "C P D P D D L", "C P D P P P L", "C D P D P D L", "C P P P P D L", "C P D D P P L", "C P P D P D L", "C P P D D D L", "C D D P P D L", "C P P D D P L", "C P P P D P L", "C D P P D P L", "C P D P D P L", "C P P D P P L", "C P P P P P L" }); //"C D D P P P L" findet er nicht, wenn ich mit BoxSize-Faktor von 10 arbeite
            Assert.IsTrue(string.IsNullOrEmpty(error), error, error);
        }
        ...
        //Der MIS-2er-Kominbtionstest für WithDistance mit DirectLightingOnEdge befindet sich in der DirectLightingOnEdge-Test-Klasse
    }
}
